<?php
namespace NakSued\NewsJsonimport\Jobs;
 ...
 */
class JSONNewsImportJob extends \Tx_News_Jobs_AbstractImportJob {
	/**
	 * @var int
	 */
    ...
    public function setImportFile($importFile) { 
		$this->importDataProviderService->setImportFile($importFile);
    }
	 ...
	 *
	 * @param \BeechIt\NewsTtnewsimport\Service\Import\JSONNewsDataProviderService $importDataProviderService
	 * @return void
	 */
	public function injectImportDataProviderService(\NakSued\NewsJsonimport\Service\Import\JSONNewsDataProviderService
